...
if (window.location.search == "?error"){
	...
	$.getJSON( "https://intense-escarpment-3682.herokuapp.com/organization/" + params.id, function(data) {
		console.log("successful ajax post");
			...
			document.getElementById('expensesPage').innerHTML = 'See Expenses: ' + "<a class='btn' href='https://intense-escarpment-3682.herokuapp.com/expenses.html?id=" + data.id + "'> " + data.name + "</a>"
