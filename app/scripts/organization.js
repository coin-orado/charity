...
if (window.location.search == "?error"){
	...
	$.getJSON( "https://intense-escarpment-3682.herokuapp.com/organization/" + params.id, function(data) {
		console.log("successful ajax post");
			...
			document.getElementById('facebook_share').innerHTML='<div class="fb-share-button" data-href="https://intense-escarpment-3682.herokuapp.com/organization.html?id='+ data.id +'" data-layout="button"></div>';
